...
#[derive(Debug)]
pub struct SenpaiLibProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SenpaiLibProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SenpaiLib processing");
    
    let mut processor = SenpaiLibProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SenpaiLibProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SenpaiLibProcessor::new(false);
